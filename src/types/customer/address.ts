...
export type AddressHandler<T extends CustomerAddressTypes = CustomerAddressTypes> =
  GetAddressesHook<T> & {
    body: { cartId?: string };
  };

export type AddItemHandler<T extends CustomerAddressTypes = CustomerAddressTypes> =
  AddItemHook<T> & {
    body: { cartId: string };
  };
