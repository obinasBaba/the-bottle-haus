...
const documents = {
    ...
    "query SearchProducts($search: String!, $sortBy: ProductOrderField!, $sortDirection: OrderDirection!, $collections: [ID!] = []) {\n  products(\n    first: 100\n    channel: \"default-channel\"\n    sortBy: {field: $sortBy, direction: $sortDirection}\n    filter: {search: $search, collections: $collections}\n  ) {\n    edges {\n      node {\n        ...ProductDetails\n      }\n    }\n  }\n}": types.SearchProductsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query SearchProducts($search: String!, $sortBy: ProductOrderField!, $sortDirection: OrderDirection!, $collections: [ID!] = []) {\n  products(\n    first: 100\n    channel: \"default-channel\"\n    sortBy: {field: $sortBy, direction: $sortDirection}\n    filter: {search: $search, collections: $collections}\n  ) {\n    edges {\n      node {\n        ...ProductDetails\n      }\n    }\n  }\n}"): typeof import('./graphql').SearchProductsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
